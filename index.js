...
function sortPriceInAscendingOrder(hotel1, hotel2) {
  return hotel1.price - hotel2.price;
}

function sortPriceInDescendingOrder(hotel1, hotel2) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  if (pricing === 'low-to-high') {
    hotelsCopy.sort(sortPriceInAscendingOrder);
    res.json(hotelsCopy);
  } else {
    hotelsCopy.sort(sortPriceInDescendingOrder);
    res.json(hotelsCopy);
  }
});

function sortRatingInAscendingOrder(hotel1, hotel2) {
  return hotel1.rating - hotel2.rating;
}

function sortRatingInDescendingOrder(hotel1, hotel2) {
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  if (rating === 'low-to-high') {
    hotelsCopy.sort(sortRatingInAscendingOrder);
    res.json(hotelsCopy);
  } else {
    hotelsCopy.sort(sortRatingInDescendingOrder);
    res.json(hotelsCopy);
  }
});

function sortReviewsInAscendingOrder(hotel1, hotel2) {
  return hotel1.reviews - hotel2.reviews;
}

function sortReviewsInDescendingOrder(hotel1, hotel2) {
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  if (reviews === 'least-to-most') {
    hotelsCopy.sort(sortReviewsInAscendingOrder);
    res.json(hotelsCopy);
  } else {
    hotelsCopy.sort(sortReviewsInDescendingOrder);
    res.json(hotelsCopy);
  }
});
